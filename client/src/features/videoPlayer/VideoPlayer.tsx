...
//           </div>
//           {/* Controls row */}
//           <div className="controls" style={{ display: 'flex', alignItems: 'center', gap: 15, padding: '10px 35px 10px', border: 0 }}>
...
//               display: 'flex',
//               alignItems: 'center',
//               gap: 10, // More gap between annotation tools and undo/redo
//               background: '#23272f',
//               borderRadius: '0 0 12px 12px',
//               borderTop: '1px solid #232323',
//               padding: '6px 55px 0px',
//               marginBottom: 0,
//               width: '100%',
...
// ----> current Youtube like structure
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', width: '100%' }}>
            <video
              ...
              onTimeUpdate={handleTimeUpdate}
              onLoadedMetadata={handleLoadedMetadata}
              style={{ width: '100%', height: 450, display: 'block', background: '#000', borderRadius: '12px 12px 0 0' }}
              tabIndex={0}
            />
            <AnnotationsCanvas currentTime={currentTime} playing={playing} />
          </div>
          ...
          {/* Controls row */}
          <div className="controls" style={{ display: 'flex', alignItems: 'center', gap: 35, padding: '5px 45px 5px', border: 0 }}>
            <button onClick={handlePlayPause} aria-label="Play/Pause">
              {playing ? <FiPause size={22} /> : <FiPlay size={22} />}
            </button>
            <button onClick={() => frameByFrame(-1)} title="Previous frame" aria-label="Previous frame">
